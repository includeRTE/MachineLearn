...
# normal value    newValue = (oldValue - min)/(max-min)
...
def datingClassTest():
    ...
    for i in range(numTestVecs):
        ...
        print('the lassifier came back with: %d,the real answer is: %d' % (classifierResult,datingLabels[i]))
...
def classifyPerson():
    ...
    percenTats = float(input('percentage of time spent playing ideo games?'))
